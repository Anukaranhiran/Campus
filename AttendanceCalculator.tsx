...
export class Backend implements backendInterface {
    ...
    async addCareerSuggestion(arg0: string, arg1: CareerSuggestion): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCareerSuggestion(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async calculateAttendanceRisk(arg0: AttendanceInput): Promise<AttendanceRisk> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateAttendanceRisk(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCareerSuggestion(arg0: string): Promise<CareerSuggestion> {
        if (this.processError) {
            try {
                const result = await this.actor.getCareerSuggestion(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
